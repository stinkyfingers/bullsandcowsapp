import {
  CheckAnswer, red, blue, green, yellow, orange, purple
} from './game';
  ...
  const tests = [
    {
      ...
      game: { answer: { 1: red, 2: green, 3: blue, 4: red } },
      expected: { bulls: 4, cows: 0 },
    },
    {
      name: '2 bulls, 1 cow',
      answer: { 1: red, 2: green, 3: blue, 4: blue },
      game: { answer: { 1: red, 2: blue, 3: blue, 4: yellow } },
      expected: { bulls: 2, cows: 1 },
    },
    {
      name: 'no matches',
      answer: { 1: red, 2: green, 3: blue, 4: blue },
      game: { answer: { 1: purple, 2: yellow, 3: orange, 4: yellow } },
    ...
    },
    {
      ...
      game: { answer: { 1: red, 2: yellow, 3: yellow, 4: yellow } },
